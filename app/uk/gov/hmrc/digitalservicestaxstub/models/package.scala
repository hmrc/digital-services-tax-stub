...
package object models {
  ...
  implicit val contactDetailsFormatter: OFormat[RosmRequestWithoutIDContactDetails]       =
    Json.format[RosmRequestWithoutIDContactDetails]
  implicit val organisationWithoutIdFormatter: OFormat[RosmRegisterWithoutIDOrganisation] =
    Json.format[RosmRegisterWithoutIDOrganisation]
  implicit val rosmRegisterWithoutIDRequest: OFormat[RosmRegisterWithoutIDRequest]        =
    Json.format[RosmRegisterWithoutIDRequest]
  implicit val rosmRegisterResponseWithoutID: OFormat[RosmRegisterWitoutIDResponse]       =
    Json.format[RosmRegisterWitoutIDResponse]
